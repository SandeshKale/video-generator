...
/* Small pulsing "signal flow" caret bridging the gap between a scene's
   headline and its main content block — cheap, on-theme way to make that
   gap read as an intentional connector instead of empty space. */
.flow-caret{font-family:'JBMono',monospace;font-size:30px;color:rgba(0,229,255,0.5);text-align:center;width:100%;z-index:1;will-change:transform,opacity;}
...
<div class="safe" id="safe">
  ...
  <div class="scene" id="sc3">
    ...
    <div class="flow-caret" id="s3caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc4">
    ...
    <div class="flow-caret" id="s4caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc5">
    ...
    <div class="flow-caret" id="s5caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc7">
    ...
    <div class="flow-caret" id="s7caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc8">
    ...
    <div class="flow-caret" id="s8caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc9">
    ...
    <div class="flow-caret" id="s9caret">▾</div>
    <div class="band-content">
  ...
  <div class="scene" id="sc10">
    ...
    <div class="flow-caret" id="s10caret">▾</div>
    <div class="band-content">
...
var SCENES = [
  ...
  { start: 9, duration: 6, el: $('sc3'), render: function(t){
      ...
      enter($('s3caret'), eoc((t-0.55)/0.3), 8, 1);
  ...
  { start: 15, duration: 7, el: $('sc4'), render: function(t){
      ...
      enter($('s4caret'), eoc((t-0.55)/0.3), 8, 1);
  ...
  { start: 22, duration: 6, el: $('sc5'), render: function(t){
      ...
      enter($('s5caret'), eoc((t-0.55)/0.3), 8, 1);
  ...
  { start: 38, duration: 6, el: $('sc7'), render: function(t){
      ...
      enter($('s7caret'), eoc((t-0.55)/0.3), 8, 1);
  ...
  { start: 44, duration: 6, el: $('sc8'), render: function(t){
      ...
      enter($('s8caret'), eoc((t-0.35)/0.3), 8, 1);
  ...
  { start: 50, duration: 5, el: $('sc9'), render: function(t){
      ...
      enter($('s9caret'), eoc((t-0.15)/0.3), 8, 1);
  ...
  { start: 55, duration: 5, el: $('sc10'), render: function(t){
      ...
      enter($('s10caret'), eoc((t-0.2)/0.3), 8, 1);
